...
def part_1(data_list):	
	...
	while start < end:
		...
		if _sum < 2020:
			...
			print(f"{data_list[start]} + {data_list[end]} = {_sum}. Product = {data_list[start]*data_list[end]}")
			exit(0)
	...
	for start in range(len(data_list)):
		...
		while mid <= end:
			...
			if _sum < 2020:
				...
				print(f"{data_list[start]} + {data_list[mid]} + {data_list[end]} = {_sum}. Product = {data_list[start]*data_list[mid]*data_list[end]}")
				exit(0)
